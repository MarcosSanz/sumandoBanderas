...
@Component({
    selector: 'app-road-trip2',
    templateUrl: './road-trip2.component.html',
    styleUrls: ['./road-trip2.component.css']
})
export class RoadTrip2Component {
    ...
    siguiente = 'Philadelphia y Outlet';
    siguienteDonde = '/roadtrip-eeuu-dia-3';
    anterior = 'Viaje y Bostón';
    anteriorDonde = '/roadtrip-eeuu-dia-1';
