...
@Component({
  selector: 'app-road-trip6',
  templateUrl: './road-trip6.component.html',
  styleUrls: ['./road-trip6.component.css']
})
export class RoadTrip6Component {
    ...
    imagenModal5 = '../../../assets/imagenes/galeriaEEUU/dia7-7.jpg';
    imagenModal6 = '../../../assets/imagenes/galeriaEEUU/dia7-3.jpg';
    titulo1 = 'Memorial al cuerpo de Marines U.S.';
    titulo2 = 'Ruta 66';
    titulo3 = 'Cementerio de Arlington';
    titulo4 = 'Cementerio de Arlington';
    titulo5 = 'Junior´s';
    titulo6 = 'Times Square';

    siguiente = 'New York';
    siguienteDonde = '/roadtrip-eeuu-dia-7';
    anterior = 'Washington D.C';
    anteriorDonde = '/roadtrip-eeuu-dia-5';
