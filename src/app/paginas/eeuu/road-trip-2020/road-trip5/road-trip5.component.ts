...
@Component({
  selector: 'app-road-trip5',
  templateUrl: './road-trip5.component.html',
  styleUrls: ['./road-trip5.component.css']
})
export class RoadTrip5Component {
    ...
    siguiente = 'New York';
    siguienteDonde = '/roadtrip-eeuu-dia-6';
    anterior = 'Philadelphia, Lancaster y Gettysburg';
    anteriorDonde = '/roadtrip-eeuu-dia-4';
