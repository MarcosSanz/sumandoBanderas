...
@Component({
  selector: 'app-road-trip3',
  templateUrl: './road-trip3.component.html',
  styleUrls: ['./road-trip3.component.css']
})
export class RoadTrip3Component {
    ...
    siguiente = 'Philadelphia, Lancaster y Gettysburg';
    siguienteDonde = '/roadtrip-eeuu-dia-4';
    anterior = 'Salem y Bostón';
    anteriorDonde = '/roadtrip-eeuu-dia-2';
